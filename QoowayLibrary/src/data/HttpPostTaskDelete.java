...
public class HttpPostTaskDelete extends AsyncTask<String, Void, String> {
	...
	public HttpPostTaskDelete(QoowayActivity activity, EnumData.request_mode rm) {
		this.activity = activity;
	}

	public HttpPostTaskDelete(QoowayActivity activity, Boolean xml) {
		this.activity = activity;
		this.Xml = true;
	}
	...
	private HttpURLConnection httpsConnection(String urlString)
		...
		HostnameVerifier hostnameVerifier = new HostnameVerifier() {
			...
			public boolean verify(String hostname, SSLSession session) {
				...
				return hv.verify(HttpPostTaskDelete.this.getHostName(), session);   // I5WIN2008R2
			}
		};
