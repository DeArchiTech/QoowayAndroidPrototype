...
public class HttpPostTaskSearch extends AsyncTask<String, Void, String> {
	...
	public HttpPostTaskSearch(QoowayActivity activity, EnumData.request_mode rm) {
		this.activity = activity;
	
		this.rm = rm;
	}

	public HttpPostTaskSearch(QoowayActivity activity, Boolean xml) {
		this.activity = activity;
		this.Xml = true;
...
/*
	...
	*/
	...
	private HttpURLConnection httpsConnection(String urlString)
		...
		HostnameVerifier hostnameVerifier = new HostnameVerifier() {
			...
			public boolean verify(String hostname, SSLSession session) {
				...
				return hv.verify(HttpPostTaskSearch.this.getHostName(), session);   // I5WIN2008R2
			}
		};
	...
	private enum status
	{
	 ...
	 {
		 String test = activity.getString(DataStorageManager.getSingletonInstance().getApiKeyStore());
		 return DataStorageManager.getSingletonInstance().getApiKeyStore();
	 }

	 private String getHostName()
	 {
		 String test = DataStorageManager.getSingletonInstance().getApiHostNameVerfier();
		 return DataStorageManager.getSingletonInstance().getApiHostNameVerfier();
	 }
	 
	 private String getKeyStorePassWord()
	 {
		 String test = DataStorageManager.getSingletonInstance().getKeyStorePassword();
